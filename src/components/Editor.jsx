...
const Editor = forwardRef(({ content, onChange }, ref) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border-2 border-slate-300 focus-within:border-emerald-500 focus-within:outline-none transition-all w-full">
      ...
      >
        <EditorContent
          editor={editor}
          className="
        prose prose-lg max-w-none min-h-[500px]
        focus:outline-none
